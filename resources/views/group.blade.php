...
<body class="h-full font-pt-one">
        ...
        <main class="bg-cover" style="background-image: url('/img/bg-2.png'); background-size: auto;">
            <!-- FILOSOFI LOGO POSITRON Section -->
            <div id="logo" class="relative text-center py-20">
                <p class="text-3xl md:text-7xl font-extrabold">GRUP POSITRON</p>
            </div>
            <div class="content-container">
            <!-- Search Bar and Table Section -->
    <div class="table-container mx-auto px-4 py-8">
        <div class="search-container">
            <input type="text" id="searchInput" onkeyup="searchTable()" placeholder="Cari namamu di sini..." class="search-bar">
            <i class="fa fa-search search-icon"></i>
        </div>
        
        <table class="pretty-table mx-auto" id="dataTable">
                    <thead>
                        <tr>
                            <th>Column 1</th>
                            <th>Column 2</th>
                ...
                for (j = 0; j < td.length; j++) {
                    if (td[j]) {
                        ...
                        if (txtValue.toLowerCase().indexOf(filter) > -1) {
                            tr[i].style.display = "";
                            break; // Show the row if any cell matches the filter
                        }
                    }
                }
            }
